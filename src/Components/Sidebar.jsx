...
export default function Sidebar() {
    ...
    return (
        <>
            <div className='sidebar h-screen fixed shadow-xl'>

                {/* <div className='h-screen'> */}

                    <div className='h-full flex item-center rounded-lg overflow-hidden'>

                        {/* ALL COMPONENTS ICONS */}
                        <div className='h-screen w-24 flex flex-col shadow-xl'>
                            ...
                            <div className='mt-auto my-1 h-12  flex items-center justify-center bg-white'>
                        ...
                        <div className='overflow-hidden xl:w-full w-0 z-10'>
                            {/* ALL COMPONENTS NAME */}
                            <div className='w-full h-full z-0 flex flex-col sidebar_items slide-right' id=''>
                                <div className="ps-3 h-28 flex items-center">
                                    <h1 className='font-serif text-2xl font-bold'><i>Instagram</i></h1>
                                </div>
                                <Link to='/'><p className='ps-3 my-1 h-12 text-lg flex items-center w-full hover:bg-slate-100 rounded-lg' >Home</p></Link>
                                ...
                                <Link to='/Explore'><p className='ps-3 my-1 h-12 text-lg flex items-center w-full hover:bg-slate-100 rounded-lg'>Explore</p></Link>
                                <Link to='/Messages'><p className='ps-3 my-1 h-12 text-lg flex items-center w-full hover:bg-slate-100 rounded-lg'>Messages</p></Link>
                                <Link to='/CreatePost'><p className='ps-3 my-1 h-12 flex text-lg items-center w-full hover:bg-slate-100 rounded-lg'>Create</p></Link>
                                <Link to='/Profile'><p className='ps-3 my-1 h-12 text-lg flex items-center w-full hover:bg-slate-100 rounded-lg'>Profile</p></Link>
